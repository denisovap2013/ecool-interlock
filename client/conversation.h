...
// Commands
#define CMD_GET_ALLVALUES "UBS:GET:ALLVALUES"

#define CMD_GET_DI_VALUES "UBS:GET:DI:VALUES"
#define CMD_GET_DI_NAMES  "UBS:GET:DI:NAMES"
#define CMD_GET_DQ_VALUES "UBS:GET:DQ:VALUES"
#define CMD_GET_DQ_NAMES  "UBS:GET:DQ:NAMES"

#define CMD_GET_DIAGNOSTICS "UBS:GET:DIAGNOSTICS"

#define CMD_GET_ADC_VALUES "UBS:GET:ADC:VALUES"
#define CMD_GET_ADC_NAMES "UBS:GET:ADC:NAMES"
#define CMD_GET_ADC_COEFFICIENTS "UBS:GET:ADC:COEFFS"

#define CMD_SET_DAC_VALUE "UBS:GET:DAC:VALUE"
#define CMD_GET_DAC_VALUES "UBS:GET:DAC:VALUES"
#define CMD_GET_DAC_NAMES "UBS:GET:DAC:NAMES"
		
#define CMD_GET_CONNECTION_STATE "UBS:GET:CONNECTIONSTATE"
		
#define CMD_GET_EVENTS "UBS:GET:EVENTS"  
